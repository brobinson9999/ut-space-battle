class UTTeamGameFacade extends UTTeamGame abstract;
...
// ********************************************************************************************************************************************
  ...
  var UTTeamGameAdapter gameEngineAdapter;
...
simulated function handleSeamlessTravelPlayer(out Controller newPlayer) {
  gameEngineAdapter.newPlayerJoined(newPlayer);
}
...
{
  // don't call gameEngineAdapter.cleanup() here - it calls this cleanup function!
...
defaultproperties
{
  ...
  OnlineGameSettingsClass=class'TeamDeathmatchGameSettings'
}