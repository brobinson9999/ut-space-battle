class FX_TrailBeam extends ScalableBeamEmitter;
...
defaultproperties
{
	...
	Begin Object Class=BeamEmitter Name=BeamEmitter0
		...
		UseColorScale=True
		ColorScale(0)=(RelativeTime=0)
		ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=255,R=255))
		ColorScale(2)=(RelativeTime=1.000000)

		UseSizeScale=True
		UseRegularSizeScale=False
		SizeScale(0)=(RelativeTime=0)
		SizeScale(1)=(RelativeSize=0.1,RelativeSize=1)
		SizeScale(2)=(RelativeTime=1)
